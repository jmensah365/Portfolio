...
function SDECard() {
    ...
    return (
        ...
        <div className='flex items-center justify-center'>
            <div onClick={() => navigateTo('/SDE')} className="flex flex-col border-2 border-gray-700 rounded-2xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 shadow-lg p-8 w-96 cursor-pointer hover:animate-pulse hover:outline-4 outline-blue-400 hover:outline-double">
